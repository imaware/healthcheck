...
{{- define "healthcheck.iamAccountName" -}}
{{ include "healthcheck.serviceAccountName" . | trunc 25 | trimSuffix "-" }}
{{- end }}

{{- define "healthcheck.gcpAccountName" -}}
{{ include "healthcheck.iamAccountName" . }}@{{ $.Values.iamServiceAccount.project }}.iam.gserviceaccount.com
{{- end }}
